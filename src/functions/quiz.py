    ...
    def quiz_word(vocabulary):
        ...
        while quiz_timer>0:
            ...
            if quiz_timer==0:   
                ...
                text=["Viper Quiz Mode : Autogenerated Report", "Hi there, welcome to your QUIZ REPORT",f"Today's date: {date}", 
                    f"you scored: {percentage}%", f"You played {rounds} rounds", f"you played for {quiz_timer} seconds",
                    ]
